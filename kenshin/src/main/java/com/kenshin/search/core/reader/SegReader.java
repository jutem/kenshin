...
public class SegReader extends AbstractReader implements EventHandler<SegDirectoryEvent>{
	...
	public SegReader(DisruptorResourcePool resourcePool, ReaderManager readerManager) {
		super(resourcePool, readerManager);
	}

	@Override
	public void onEvent(SegDirectoryEvent event, long paramLong, boolean paramBoolean) throws Exception {
